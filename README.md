...
Para la tercera entrega la hemos desarrollado conjuntamente Vidal y yo, cada uno se ha encargado de apartados diferentes en diferentes ramas para trabajar en conjunto, hemos decidido hacer todos los apartados. Vidal se encargo del sistema de salud, puntuación y las animaciones del personaje y yo me he encargado de la navegación con navmesh y la fsm del enemigo con enums.

### Resumen 
- IA de enemigo con navmesh
- FSM enemigo (patrol y chase)
- Player con animation controller 
- Sistema de salud
...
* ** Vídeo explicativo (tercera entrega):**
  
[Laberinto3.mp4](https://1drv.ms/v/c/40d7f72d38f468c7/IQA3qDe3NLaRR4pwDXgQDXvhAf4E0WIA3B7Js3oc_sn-Qtg?e=6EKPGk)
...
* [https://kaizzendev.itch.io/laberinto-actividad-grupal](https://kaizzendev.itch.io/laberinto-actividad-grupal)
